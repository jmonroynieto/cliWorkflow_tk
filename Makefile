...
build_dir := build/
TOOLS := ansCRUBi ansible barker calshow cedula chaptor cueLine cw describeFiles dripC fickleFinger filterMyCal indexFiles kompti kwiqExt lineExplorer  lotajxo mdMake megalophobia quoteadder shFossils watchAdir xwin zustellen
