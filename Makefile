...
build_dir := build/
TOOLS := ansCRUBi ansible barker calshow cedula chaptor cueLine cw describeFiles dripC fickleFinger filterMyCal indexFiles janus kompti kwiqExt lineExplorer  lotajxo mdMake megalophobia quoteadder shFossils watchAdir xwin zustellen
